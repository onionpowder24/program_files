...
data <- na.omit(data)
#水準をfactor型に変換
data.2 <- lapply(data[,1:15],as.factor)
...
boxplot(Characteristic_value~F,ylab = "Characteristic_value",xlab = "F",data=data)
...
stripchart(Characteristic_value~F,vertical = TRUE,method="stack", ylab = "Characteristic_value",xlab = "F",data=data)
...
plotMeans(data$Characteristic_value,data$F,error.bars ="se")
...
#交互作用A×C
plotMeans(data$Characteristic_value,data$A,data$C,error.bars ="se")
plotMeans(data$Characteristic_value,data$C,data$A,error.bars ="se")

#交互作用A×D
plotMeans(data$Characteristic_value,data$A,data$D,error.bars ="se")
plotMeans(data$Characteristic_value,data$D,data$A,error.bars ="se")

#交互作用C×D
plotMeans(data$Characteristic_value,data$C,data$D,error.bars ="se")
plotMeans(data$Characteristic_value,data$D,data$C,error.bars ="se")

#交互作用D×F
plotMeans(data$Characteristic_value,data$D,data$F,error.bars ="se")
plotMeans(data$Characteristic_value,data$F,data$D,error.bars ="se")
...
LinearModel.1<-lm(Characteristic_value ~ A + B + C + D + F + A:B + A:C + A:D + C:D + D:F,data=data)
