...
number_of_selecting_samples = 8  # 選択するサンプル数。列の数よりも小さくすること。
number_of_random_searches = 100000  # ランダムにサンプルを選択して D 最適基準を計算する繰り返し回数

x_generated = pd.read_csv('correlation_reduced_data.csv', index_col=0, header=0)
...
# ループ終了後に行列式を表示 (オリジナルから追加)
print('最大の行列式 (D最適基準) =', best_d_optimal_value)
